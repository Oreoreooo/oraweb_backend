# import pyaudio  # Commented out for deployment
import wave
import numpy as np
import threading
import queue
...
class ASRService:
    ...
    def _initialize(self):
        try:
            ...
            # Audio parameters
            self.CHUNK = 1024
            # self.FORMAT = pyaudio.paFloat32  # Commented out for deployment
            self.CHANNELS = 1
            self.RATE = 16000
            
            # Initialize PyAudio - Commented out for deployment
            ...
            # Test microphone access - Commented out for deployment
    ...
    def _test_microphone(self):
        """Test if microphone is accessible - Commented out for deployment"""
        # try:
        #     stream = self.p.open(
        #         format=self.FORMAT,
    ...
    def start_recording(self):
        """Start recording audio from microphone - Commented out for deployment"""
        ...
        return {"error": "Real-time recording disabled for deployment"}

    def stop_recording(self):
        """Stop recording and process the audio - Modified for deployment"""
    ...
    def process_audio_file(self, audio_data):
        """Process audio file data for ASR - Alternative to real-time recording"""
        try:
    ...
    def cleanup(self):
        """Clean up resources - Modified for deployment"""
        try:
            self.is_running = False
            self.is_recording = False
            if hasattr(self, 'record_thread'):
                self.record_thread.join(timeout=2.0)
            # self.p.terminate()  # Commented out for deployment
        except Exception as e:
